...
{
  float V0[3] = { pFace1->m_vDot1.x, pFace1->m_vDot1.y, pFace1->m_vDot1.z };
  float V1[3] = { pFace1->m_vDot2.x, pFace1->m_vDot2.y, pFace1->m_vDot2.z };
  float V2[3] = { pFace1->m_vDot3.x, pFace1->m_vDot3.y, pFace1->m_vDot3.z };
  float U0[3] = { pFace2->m_vDot1.x, pFace2->m_vDot1.y, pFace2->m_vDot1.z };
  float U1[3] = { pFace2->m_vDot2.x, pFace2->m_vDot2.y, pFace2->m_vDot2.z };
  float U2[3] = { pFace2->m_vDot3.x, pFace2->m_vDot3.y, pFace2->m_vDot3.z };
  //float E1[3],E2[3];
  float N1[3],N2[3],d1,d2;
  float du0,du1,du2,dv0,dv1,dv2;
  float D[3];
  ...
  //SUB(E2,V2,V0);
  //CROSS(N1,E1,E2);
  N1[0] = pFace1->m_vNor.x;
  N1[1] = pFace1->m_vNor.y;
  N1[2] = pFace1->m_vNor.z;
  d1=-DOT(N1,V0);
  /* plane equation 1: N1.X+d1=0 */
  ...
  //SUB(E2,U2,U0);
  //CROSS(N2,E1,E2);
  N2[0] = pFace2->m_vNor.x;
  N2[1] = pFace2->m_vNor.y;
  N2[2] = pFace2->m_vNor.z;
  d2=-DOT(N2,U0);
  /* plane equation 2: N2.X+d2=0 */
